...
var Dashboard = function() {
    ...
    /*Dashboard Default DaterangePicker*/
    ...
    var profitShare = function() {
        ...
        var chart = new Chartist.Pie('#m_chart_profit_share', {
            series: [{
                    value: $('.todays_completion_ratio').val(),
                    className: 'custom',
                    meta: {
                ...
                {
                    value: $('.todays_acceptance_ratio').val(),
                    className: 'custom',
                    meta: {
                ...
                {
                    value: $('.todays_cancelled_ratio').val(),
                    className: 'custom',
                    meta: {
    ...
    //== Sales Stats2.
    //** Based on Chartjs plugin - http://www.chartjs.org/
    var salesStats2 = function() {
        if ($('#m_chart_sales_stats_2').length == 0) {
            return;
        }
        ...
        var chart = new Chart($('#m_chart_sales_stats_2'), config);
    }
